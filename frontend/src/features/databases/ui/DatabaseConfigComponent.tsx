    ...
    databaseApi
      ...
      .then((copiedDatabase) => {
        ToastHelper.showToast({
          title: t('databaseCopied'),
          description: t('databaseCopiedDescription', { name: copiedDatabase.name }),
        });
    ...
    databaseApi
      ...
      .then(() => {
        ToastHelper.showToast({
          ...
          description: t('connectionTestDescription'),
        });
    ...
    <div className="relative w-full rounded-tr-md rounded-br-md rounded-bl-md bg-white p-3 shadow sm:p-5 dark:bg-gray-800">
      ...
      {database.lastBackupErrorMessage && (
        <div className="mb-4 max-w-full rounded border border-red-600 px-3 py-3 sm:max-w-[400px]">
          ...
          <div className="mt-3 text-sm text-gray-500 dark:text-gray-400">
            {t('toCleanError')}
            <ul>
              <li>- {t('testConnectionButton')}</li>
              <li>- {t('waitNextBackup')}</li>
            </ul>
          </div>
        </div>
      )}
      ...
      {isShowCopyConfirm && (
        <ConfirmationComponent
          ...
          description={t('copyDatabaseConfirmation')}
          actionText={t('copyDatabase')}
      ...
      {isShowRemoveConfirm && (
        <ConfirmationComponent
          ...
          description={t('removeDatabaseConfirmation')}
          actionText={t('removeDatabase')}
